  ...
  <body>
    <header class="container">
      <nav class="navbar navbar-expand-md p-md-0 row">
        <a class="logo col-5 col-sm-4 col-md-2 pl-md-0" href="#">  <img src="img/logo.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav col-sm col-md-10">
            <a class="nav-item nav-link h5 col-sm" href="#">Главная</a>
            <a class="nav-item nav-link h5 col-sm" href="#">О проекте</a>
            <a class="nav-item nav-link h5 col-sm" href="#">Материалы</a>
            <a class="nav-item nav-link h5 col-sm" href="#">Эксперты</a>
            <a class="nav-item nav-link h5 col-sm" href="#">Контакты</a>
          </div>
...
<!-- // d-md-flex align-items-center p-0 row -->
            <div class="row">
              <div class="col-md-8 col-sm-12 lang">
                <button class="btn btn-secondary dropdown-toggle h5 float-md-right" type="button" id="dropdownLangButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                RU
                </button>
              ...
              <div class="col-md-4 col-sm-12 pr-0 search">
                  <button class="btn btn-secondary" type="button" data-toggle="collapse" data-target="#collapseSearch" aria-expanded="false">
          ...
          <div class="collapse search" id="collapseSearch">
            <input class="form-control" placeholder="Введите запрос и нажмите Enter" aria-label="Search" type="text">
    ...
    <main role="main">
      <div class="map">
        <div class="container">
          <div class="map-title  d-md-none d-sm-block">
            Геостратегический атлас Большого Средиземноморья
          </div>
          <div class="region d-flex">
            <div class="col-3 icon p-0">
              <img src="img/menu-button.png" alt="">
            </div>
            <div class="col-9 p-0">
              <a class="region_a" href="#">Выберите регион</a>
            </div>
          </div>
        </div>
      </div>
      <div class="container map_block">
        <div class="row">
           <div class="col-5 map_one-block map-title  d-md-block d-none">
             Геостратегический атлас Большого Средиземноморья
           </div>
      ...
      <div class="description">
        <div class="container p-md-0">
          <div class="description_item col-10 p-0 pl-md-5 ml-md-4">
            «Геостратегический атлас Большого Средиземноморья» - это уникальный междисциплинарный проект, сочетающий подготовку научно-аналитических текстов и статистических материалов с инфографическими и картографическими разработками по проблемам государств Большого Средиземноморья – стран, располагающихся в бассейнах Азовского, Черного и Средиземного морей.
          </div>
        </div>
      </div>
      <div class="articles last periods ">
        ...
        <div class="materials-slider">
            <div class="slider desktop slider-container">
          ...
          <div class="slider mobile slider-container">
              <div class="slider-item">
                  <div class="slider-item__wrapper">
                      <div class="item-slide">
                          <a class="item-slide__link" href="#"></a>
      ...
      <div class="articles last">
          ...
          <div class="container">
            <div class="row">
                  ...
                  <div class="card text-center item" style="background-image:url(img/last_1.png); background-size: cover">
                   ...
                   <div class="card text-center item" style="background-image:url(img/last_2.png); background-size: cover">
                    ...
                    <div class="card text-center item second">
                     ...
                     <div class="card text-center item third" style="background-image:url(img/last_3.png);">
              ...
              <div class="col-3 articles_list d-lg-block d-none">
                <div class="item">
                  <p class="title">Идеи гедонизма занимают центральное место в утилитаризме</p>
                  <p class="date">15 января</p>
                </div>
    ...
    <script src="plugins/jquery.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
